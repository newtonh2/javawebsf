...
public class DAOProduto {
	...
	public static void alterarProduto(String nome, String descricao, int id) throws Exception {
		String sql = "update produtos set nome '" + nome + "', descricao = '" + descricao + "' where codigo = "+ id ;
		Conexao.getStatement().executeUpdate(sql);
	}
